...
config['note']['note'] = 'final experiment, synonym pairs, architectue:'+ sysargv1 + ' encoder, ' + sysargv2 + ', continue training lr=0.00005, truncated dev set'
#################################################
...
name = 'fe_synpair_' + sysargv1+'_'+sysargv2+'.pickle'
